...
public:
    ...
    :i_width(1280)
  {
    ...
    planner=nh.advertiseService("fli_planning/plan_flight", &FlightPlanner::plannerCB,this);
    georeferencer=nh.advertiseService("fli_planning/georef_points", &FlightPlanner::georeferencerCB,this);
  }
  ///Object destructor
  ~FlightPlanner()
  {
