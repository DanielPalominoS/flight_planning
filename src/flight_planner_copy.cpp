...
void  flight_planner::generate_points(std::vector<cv::Mat>* navf_points,std::vector<line_class>* lines,
  ...
  row_line.move_line(side_vector->at<double>(0,0),side_vector->at<double>(1,0));
  /**********************************************/
...
void flight_planner::find_max_min_x_y(std::vector<cv::Mat>  points,cv::Mat* max_vector,
                      cv::Mat* min_vector){
...
uint  flight_planner::find_initial_point_and_side_vector(std::vector<cv::Mat>* navf_points,std::vector<line_class>* lines,
                                         cv::Mat* row_vector,double x_max,double y_max,double x_min,double y_min,
...
void  flight_planner::rotate_vetor(cv::Mat* orig ,cv::Mat* rotated,double magnitude, double  rotation,bool are_degrees){
  double theta;
  if(are_degrees){
...
void  flight_planner::polar2cart(double *x,double* y,double r,double theta,bool is_deg){
  if(is_deg){
    theta*=M_PI/180.0;
  }
  *x=r*cos(theta);
...
void  flight_planner::polar2cart(cv::Mat *vector,double r,double theta,bool is_deg){
  if(is_deg){
    theta*=M_PI/180.0;
  }
...
void  flight_planner::imu2cvMat(geometry_msgs::Vector3 imu,cv::Mat* imu_mat){
...
void  flight_planner::gps2cvMat(geometry_msgs::Vector3  gps,cv::Mat* gps_mat){
...
void  flight_planner::cvMat2gps(sensor_msgs::NavSatFix  *gps,cv::Mat* gps_mat){
...
void  flight_planner::cvMat2gps(geometry_msgs::Vector3  *gps,cv::Mat* gps_mat){
...
void flight_planner::update_BF2NF2(cv::Mat IMU_ori,cv::Mat* BF2NF,bool is_degrees){
    /***********
     * yaw: orientation.x
     * pitch: orientation.y
     * roll: orientation.z
...
void flight_planner::update_BF2NF(cv::Mat IMU_ori,cv::Mat* BF2NF,bool is_degrees){
    /***********
     * yaw: orientation.x
     * pitch: orientation.y
     * roll: orientation.z
...
void flight_planner::update_NF2ECEF(cv::Mat gps_position,cv::Mat* NF2ECEF,bool is_degrees){
    double lat,lon;
    if(is_degrees){
...
void flight_planner::update_ECEF2NF(cv::Mat gps_position,cv::Mat* NF2ECEF,bool is_degrees){
    double lat,lon;
    /*if(is_degrees){
...
void flight_planner::update_ECEF2NF_2(cv::Mat gps_position,cv::Mat* NF2ECEF,bool is_degrees){
    double lat,lon;
    /*if(is_degrees){
        lat=ecef_position.at<double>(0,0)*M_PI/180;
        lon=ecef_position.at<double>(0,0)*M_PI/180;
...
void flight_planner::geod2ecef(cv::Mat gps_position,cv::Mat *uav_ecef_posi,bool is_degrees){
...
void flight_planner::ecef2geod_4(cv::Mat *uav_gps_posi,cv::Mat uav_ecef_posi){
    /*
...
///converts eceef coordinates togeodetic coors(lat,lon,alt)
void flight_planner::ecef2geod_1(cv::Mat *uav_gps_posi,cv::Mat uav_ecef_posi){
    /*
     * lat: latitud geodetica
     * lon:longitud geodetica
     * lat_par: latitud parametrica
...
///converts eceef coordinates togeodetic coors(lat,lon,alt)
void flight_planner::ecef2geod_2(cv::Mat *uav_gps_posi,cv::Mat uav_ecef_posi){
    /*
     * lat: latitud geodetica
     * lon:longitud geodetica
     * lat_par: latitud parametrica
...
///converts eceef coordinates togeodetic coors(lat,lon,alt)
void flight_planner::ecef2geod_3(cv::Mat *uav_gps_posi,cv::Mat uav_ecef_posi){
    /*
     * lat: latitud geodetica
     * lon:longitud geodetica
...
void flight_planner::geod2nf(cv::Mat uav_gps_posi, cv::Mat ref_gps_posi,
...
void flight_planner::if2navf(double cam_ori, cv::Mat imu_ori, cv::Mat uav_gps_posi,
...
void flight_planner::navf2if(double cam_ori, cv::Mat imu_ori,
...
void flight_planner::georef_nav_point( cv::Mat navf_coord, cv::Mat ref_gps_posi,
...
void flight_planner::georef_image_point(double cam_ori, cv::Mat imu_ori, cv::Mat uav_gps_posi,
                        cv::Mat k,cv::Mat image_coord, cv::Mat ref_gps_posi,
